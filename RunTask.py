# from subModels import BertCRFModel, NERMain, SIMMain
# from subModels import BertCRFModel
from subModels import NERMain
from subModels import SIMMain
from subModels import BertCRF
# from BertCRFModel import BertCRF
from NERMain import NERProcessor, CRF_LABELS
from SIMMain import SimProcessor,SimInputFeatures
...
def select_database(sql):
    # connect database
    connect = pymysql.connect(user="root",password="Intel@123",host="127.0.0.1",port=3306,db="KB_QA",charset="utf8")
